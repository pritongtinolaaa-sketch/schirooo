...
- **Feb 2026**: Added batch results export — "EXPORT VALID" button appears in results summary when valid cookies are found. Downloads a `.txt` file with valid cookies separated by `=======`.
